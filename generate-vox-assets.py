...
IMAGES = [
    ...
    # Products
    ("vox-product-1", f"{BASE_STYLE}, product shot of male model wearing black oversized bomber jacket with utility pockets, black t-shirt, grey concrete background, half body"),
    ("vox-product-2", f"{BASE_STYLE}, male model wearing black stencil-print hoodie with drawstrings, hands in pocket, grey concrete background, half body"),
    ("vox-product-3", f"{BASE_STYLE}, male model from waist down in black tag utility cargo pants with side pockets, black sneakers, concrete background"),
    ...
    ("vox-look-2", f"{BASE_STYLE}, close-up portrait of male model against raw concrete wall, wearing black hoodie, intense gaze, street lighting"),
    ("vox-look-3", f"{BASE_STYLE}, group of two male models in black streetwear on a city bridge at dusk, Amsterdam skyline vibe, cinematic"),
    ("vox-look-4", f"{BASE_STYLE}, male model in oversized black jacket and cargo pants walking through neon-lit street at night, backlit"),
    ("vox-look-5", f"{BASE_STYLE}, male model leaning against concrete corridor wall, wearing black parka, moody side light, full body"),
    ("vox-look-6", f"{BASE_STYLE}, close-up editorial portrait of male model with short hair, black athletic top, urban night lighting, shallow depth of field"),

    # Friends
    ("vox-friend-1", f"{BASE_STYLE}, portrait of young woman with short hair, skater style, black streetwear, holding vintage film camera, concrete background"),
    ("vox-friend-2", f"{BASE_STYLE}, portrait of young man with headphones around neck, producer DJ vibe, black hoodie, dim neon light"),
    ("vox-friend-3", f"{BASE_STYLE}, portrait of young woman visual artist, paint smudge on cheek, black oversized jacket, industrial background"),
    ("vox-friend-4", f"{BASE_STYLE}, portrait of young male bike courier, athletic build, black windbreaker, city night background"),
]
...
def main():
    print(f"Generating {len(IMAGES)} VOX assets...\n")
    results = []
